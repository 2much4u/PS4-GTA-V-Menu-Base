...
namespace GRAPHICS
{
	...
	static void DRAW_SCALEFORM_MOVIE_FULLSCREEN(int scaleform, int red, int green, int blue, int alpha) { invoke<Void>(0x0DF606929C105BE1, scaleform, red, green, blue, alpha); } // 0x0DF606929C105BE1 0x7B48E696
